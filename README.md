...
При нажатии на `Rooms` переходим к экрану с комнатами рабочего места

![img_3.png](images/img_3.png)

При нажатии на кнопку `Edit` происходит редирект на форму для изменения параметров комнаты. Есть кнопка для удаления
комнат.
